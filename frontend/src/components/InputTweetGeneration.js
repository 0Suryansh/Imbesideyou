...
const InputTweetGeneration = () => {
    ...
    if(loggedIn){
      ...
      setOutput(res.data.output_para)
       ...
       await openai.createCompletion({
        ...
        prompt: `Generate a tweet for ${textInput}`,
        temperature: 0.7,
        max_tokens: 256,
        top_p: 1,
        frequency_penalty: 0,
  ...
  return (
    ...
    >
      ...
      >
        Paste or write about your topic and then click the Generate Button🖋️
      </Typography>
      <TextField
        fullWidth
        value={textInput}
...
export default InputTweetGeneration;
